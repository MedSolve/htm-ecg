...
# Generate random data set and test on l1
DATA = generateSet(CONFIG_L1['inputDimensions'], CONFIG_L1['uintType'])
test = Layer(CONFIG_L1)

test.compute(DATA)

classifier = TopNode(test, CONFIG)
